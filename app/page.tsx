"use client";
import { ArrowRight, HeartPulse, Lightbulb, MessageSquareHeart, Waves, Lock } from "lucide-react";
...
export default function Home() {
  ...
  function setShowDialog(arg0: boolean): void {
      ...
      <section className="relative min-h-[90vh] mt-20 flex flex-col items-center justify-center py-12 px-4">
        ...
        >
          <div className="space-y-2 text-center">
            <p className="text-sm text-muted-foreground/80 font-medium mb-6">
          ...
          <div className="relative px-2">
            ...
            />
            <div className="[&_.bg-primary]:h-0.5 [&_.bg-secondary]:h-0.5 [&_button]:h-1.5 [&_button]:w-1.5">
    <Slider
      value={[emotion]}
